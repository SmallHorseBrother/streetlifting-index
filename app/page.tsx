...
import { TrendingUp, Users, Calculator, BookOpen, ArrowRight, MapPin, Database } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="md:hidden">
        {/* 移动端Hero区域 */}
        <div className="bg-gradient-to-br from-blue-600 to-indigo-700 text-white px-4 pt-10 pb-8 safe-area-pt">
          <div className="max-w-md mx-auto text-center">
            <div className="flex items-center justify-center mb-4">
              <TrendingUp className="h-10 w-10" />
            </div>
            <h1 className="text-2xl font-bold mb-2">街健力量指数</h1>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 mb-6">
              <div className="text-3xl font-bold">
                {stats.loading ? "..." : stats.totalCount.toLocaleString()}
              </div>
              <div className="text-sm opacity-80">条社区数据已收录</div>
            </div>

            {/* 主要CTA按钮 */}
            <div className="space-y-3">
              <Link href="/calculator" className="block">
                <Button size="lg" className="w-full bg-green-500 hover:bg-green-600 text-white h-14 text-base rounded-xl">
                  <Calculator className="mr-2 h-5 w-5" />
                  计算我的力量分
                </Button>
              </Link>
              <Link href="/data" className="block">
                <Button size="lg" variant="outline" className="w-full bg-white/10 hover:bg-white/20 text-white border-white/20 h-14 text-base rounded-xl">
            ...
            <Link href="/calculator">
              <Card className="bg-white shadow-sm border-0 hover:shadow-md transition-shadow">
                <CardContent className="p-4 text-center">
                  ...
                  <div className="font-medium text-sm">力量计算器</div>
                  <div className="text-xs text-gray-500 mt-1">计算力量分</div>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link href="/data">
              <Card className="bg-white shadow-sm border-0 hover:shadow-md transition-shadow">
                <CardContent className="p-4 text-center">
                  ...
                  <div className="font-medium text-sm">数据社区</div>
                  <div className="text-xs text-gray-500 mt-1">提交与排行</div>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link href="/locations">
              <Card className="bg-white shadow-sm border-0 hover:shadow-md transition-shadow">
                <CardContent className="p-4 text-center">
                  ...
                  <div className="font-medium text-sm">寻找单杠</div>
                  <div className="text-xs text-gray-500 mt-1">附近的训练点</div>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link href="/stories">
              <Card className="bg-white shadow-sm border-0 hover:shadow-md transition-shadow">
                <CardContent className="p-4 text-center">
                  ...
                  <div className="font-medium text-sm">社区故事</div>
                  <div className="text-xs text-gray-500 mt-1">分享与交流</div>
                </CardContent>
              </Card>
            </Link>
          </div>
        ...
        <div className="px-4 pb-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-bold text-gray-900">社区动态</h2>
            <Link href="/data">
        ...
        <div className="px-4 pb-6">
          <Card className="bg-white shadow-sm border-0">
            <CardHeader className="pb-2">
              <CardTitle className="text-base">关于项目</CardTitle>
            </CardHeader>
            <CardContent className="text-sm text-gray-600 space-y-2">
              <p>由<span className="font-semibold text-gray-900">枭马葛</span>创建的科学评估体系</p>
              <div className="flex flex-wrap gap-2 pt-2">
                <span className="px-2 py-1 bg-gray-100 rounded-full text-xs">数据透明</span>
                <span className="px-2 py-1 bg-gray-100 rounded-full text-xs">社区驱动</span>
                <span className="px-2 py-1 bg-gray-100 rounded-full text-xs">科学严谨</span>
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="px-4 pb-6">
          <Card className="bg-white shadow-sm border-0">
            <CardContent className="p-4">
              <div className="text-sm font-medium text-gray-900 mb-3">关注我们</div>
              <div className="flex gap-3">
                <a
                  href="https://space.bilibili.com/495933903"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 flex items-center justify-center gap-2 bg-pink-50 text-pink-600 rounded-xl py-3 text-sm font-medium"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 flex items-center justify-center gap-2 bg-gray-900 text-white rounded-xl py-3 text-sm font-medium"
                >
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
